  ...
  app.get('/', async (request, reply) => {
    ...
    const { rows } = await query(
      `SELECT
        ...
        -- Subqueries escalares, não JOIN + GROUP BY. Mesmo produto cartesiano
        -- que estava no /feed: com 2000 publicações e 27 000 gostos, este
        -- endpoint caía para 7 pedidos/s e 5,3 s de mediana.
